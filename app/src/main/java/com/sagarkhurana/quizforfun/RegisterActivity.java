...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText ctPassword = findViewById(R.id.tieCPassword);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String cPassword = ctPassword.getText().toString();

                if (!validateInputs(username,email,password, cPassword)) return;
    ...
    private boolean validateInputs(String username, String email, String password, String cPassword){
        ...
        if (!cPassword.equals(password)){
            Toast.makeText(this, getString(R.string.cpassword_not_equal_to_password), Toast.LENGTH_SHORT).show();
            return false;
        }
